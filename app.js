document.addEventListener('DOMContentLoaded', () => {
    ...
    // Prioritize European countries at the top of the dropdown list
    ...
    countriesList.sort((a, b) => {
        const aIsEuro = europeanCodes.has(a.CountryCode) ? 1 : 0;
        const bIsEuro = europeanCodes.has(b.CountryCode) ? 1 : 0;
        return bIsEuro - aIsEuro;
    });
